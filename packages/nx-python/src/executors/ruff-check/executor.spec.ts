...
describe('Ruff Check Executor', () => {
  ...
  describe('poetry', () => {
    ...
    it('should execute ruff check linting with exitZero', async () => {
      vi.mocked(spawn.sync).mockReturnValueOnce({
        status: 0,
        output: [''],
        pid: 0,
  ...
  describe('uv', () => {
    ...
    it('should execute ruff check linting with unparsed args (no value)', async () => {
      vi.mocked(spawn.sync).mockReturnValueOnce({
        status: 0,
        output: [''],
        pid: 0,
    ...
    it('should deduplicate --exit-zero from unparsed args', async () => {
      vi.mocked(spawn.sync).mockReturnValueOnce({
        status: 0,
        output: [''],
        pid: 0,
